...
return {
  ...
  },
  {
    ...
    event = "VeryLazy",
    keys = {
      { "<leader>ji", "<Cmd>BufferLinePick<CR>", desc = "Pick" },
      { "<leader>jn", "<Cmd>BufferLinePickClose<CR>", desc = "PickClose" },
      { "<leader>jp", "<Cmd>BufferLineTogglePin<CR>", desc = "Toggle Pin" },
      { "<leader>P", "<Cmd>BufferLineGroupClose ungrouped<CR>", desc = "Delete Non-Pinned Buffers" },
      { "<leader>jo", "<Cmd>BufferLineCloseOthers<CR>", desc = "Delete Other Buffers" },
